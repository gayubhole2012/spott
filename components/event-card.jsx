...
className ="",
    ...
    if(variant === "list"){
     return(
        <Card className={`py-0 group cursor-pointer hover:shadow-lg transition-all
        ...
        >
            <CardContent className="p-3 flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-sm mb-1 group-hover:text-purple-400
                    transition-colors line-clamp-2">
                        ...
                        <div className= "flex items-center gap-1 text-ts text-muted-foreground">
...
return (
         ...
         >
            ...
            <CardContent className="space-y-3">
                ...
                <div className="space-y-2 text-sm text-shadow-muted-foreground">
...
//   console.log("LocationType:", event.locationType);
//   console.log("State:", event.state);
//   console.log("TicketType:", event.ticketType);
//   console.log("Registration:", event.registrationCount);
...
//      <CardContent className="p-3 flex gap-3">
//         {/* Event Image*/}
//     <div className="w-20 h-20 rounded-lg shrink-0 overflow-hiddden relative">
//         {event.coverImage ? (
//             <Image 
//             src={event.coverImage}
//             alt={event.title}
