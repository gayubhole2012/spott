...
export  function OnboardingModal({ isOpen, onClose, onComplete }) {
  ...
  const cities = useMemo(() => {
      ...
      const selectedState = canadianStates.find((s) => s.name === location.state);

      if(!selectedState) return [];
      return City.getCitiesOfState("CA", selectedState.isoCode);
  },[location.state, canadianStates]);
